...
import 'package:bpr_pms/app/modules/slo/controllers/slo_controller.dart';
...
class SloSloDetailView extends GetView<SloSloDetailController> {
  ...
  Widget build(BuildContext context) {
    final SloController sloController = Get.find<SloController>();
          ...
          leading: Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
                ...
                sloController.refreshData(Get.context!);
              },
            ),
          ),
          titleSpacing: 4,
