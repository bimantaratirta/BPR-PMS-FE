...
import 'package:bpr_pms/app/modules/slo/widgets/slo_card.dart';
          ...
          children: [
            ...
            Expanded(
              child: controller.isLoading.isTrue
                  ...
                  : controller.usersSloData.value.isEmpty
                  ? RefreshIndicator(
                  ...
                  : NotificationListener<ScrollNotification>(
                      onNotification: (ScrollNotification scrollInfo) {
                        if (scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent &&
                          ...
                          controller.getAllSloByAm(context);
                          return true;
                        }
                        return false;
                      },
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: controller.usersSloData.value.length + (controller.isPagingLoading.value ? 1 : 0),
                          itemBuilder: (context, index) {
                            if (index == controller.usersSloData.value.length) {
                              return Padding(
                            ...
                            final data = controller.usersSloData.value[index];

                            return Padding(
                              padding: EdgeInsets.fromLTRB(20, 0, 20, 15),
                              child: Column(
                                children: [
                                  SloCard(userData: data),

                                  index == controller.usersSloData.value.length - 1 && controller.hasMoreData.isFalse
                                      ? Align(
