...
class NasabahNasabahCreateController extends GetxController {
  ...
  Future createCustomer(BuildContext context) async {
    try {
      ...
      final response = await customerService.createCustomer(payload);

      isLoading.value = false;

      if (response.code == 201) {
        message.value = "Nasabah berhasil dibuat!";
        ...
        String errorMsg = response.message ?? "Nasabah gagal dibuat. Silakan coba lagi.";
